...
import (
	...
	ravishankarsrv1alpha1 "github.com/ravishankarsrrav/postgres-k8s-operator/pkg/apis/ravishankarsr/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &ravishankarsrv1alpha1.Postgres{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &ravishankarsrv1alpha1.Postgres{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcilePostgres) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &ravishankarsrv1alpha1.Postgres{}
...
func newPodForCR(cr *ravishankarsrv1alpha1.Postgres) *corev1.Pod {
